const Integrantes = () => {
  return (
    <div className="flex flex-col items-center p-8 ">
      ...
      {/* Card do Giovane */}
      <div className="flex flex-row items-center w-full max-w-2xl p-6 mb-8 bg-white rounded-xl shadow-lg border border-blue-600 transition-transform duration-300 ease-in-out hover:translate-y-[-5px]">
        <img
          src="/src/assets/Foto_Integrantes/GiovaneS_Integrantes.jfif"
          alt="Foto do Integrante Giovane"
          className="w-24 h-24 rounded-full mr-6 border-2 border-blue-600"
        />
        ...
        <div className="flex flex-col space-y-4">
          <a href="https://www.linkedin.com/in/giovane-amato-276217306/" target="_blank" rel="noopener noreferrer">
            <img src="/src/assets/Icones/icone-linkedin.png" alt="Icone do LinkedIn" className="w-8 h-8 transition-transform duration-300 hover:scale-110" />
          </a>
          <a href="https://github.com/RuralGiovane" target="_blank" rel="noopener noreferrer">
            <img src="/src/assets/Icones/icone_github.png" alt="Icone do GitHub" className="w-8 h-8 transition-transform duration-300 hover:scale-110" />
          </a>
        </div>
      </div>
      ...
      {/* Card do Matheus */}
      <div className="flex flex-row items-center w-full max-w-2xl p-6 bg-white rounded-xl shadow-lg border border-blue-600 transition-transform duration-300 ease-in-out hover:translate-y-[-5px]">
        <img
